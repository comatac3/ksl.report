!(function (b) {
  ...
  (o.prototype.createPlotGraph = function (o, a, t, r, e, l, i, n) {
    b.plot(
      b(o),
      [
      ...
      ],
      {
        series: {
          lines: {
            ...
            lineWidth: 2,
            fillColor: {
              colors: [{ opacity: 0.3 }, { opacity: 0.3 }, { opacity: 0.3 }],
            },
          },
          points: { show: !0 },
          shadowSize: 0,
        ...
        splines: { show: !0, tension: 0.1, lineWidth: 1 },
      }
    );
  }),
        ...
        l = {
          series: {
            pie: {
              show: !0,
              radius: 1,
              label: { show: !0, radius: 1, background: { opacity: 0.2 } },
            },
          },
          legend: { show: !1 },
    ...
    (o.prototype.init = function () {
      ...
      this.createPieGraph(
        ...
        ["Mobile Phones", "iPhone 7", "iMac", "Macbook"],
        [20, 30, 15, 32],
        ["#47dea3", "#23d0ea", "#fb6d9d", "#3f4958"]
      );
      ...
      var n = new Array();
      n.push({ label: "Series One", data: r, bars: { order: 3 } }),
        n.push({ label: "Series Two", data: l, bars: { order: 2 } }),
        n.push({ label: "Series Three", data: i, bars: { order: 1 } }),
      ...
      var s = [],
        c = [];
      for (e = 0; e < 12; e += 0.2)
        s.push([e, Math.sin(e + 0)]), c.push([e, Math.cos(e + 0)]);
      var h = [
        { data: s, label: "Google" },
        { data: c, label: "Yahoo" },
      ];
      this.createLineGraph(
        "#line-chart-alt",
        {
          ...
          x: { tickColor: "#f5f5f5", font: { color: "#bdbdbd" } },
        },
        ["#f5707a", "#188ae2"],
        h
      );
